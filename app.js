document.addEventListener("DOMContentLoaded", () => {
    ...
    //Register event listeners for save and delete
    ...
    //Generates and displays the user list with click handlers
    ...
    //Renders the portfolio for selected user
    ...
    //Populates the user form with selected user's data
